...
# Local imports
from hippotools.utils import HiddenPrints, read_model, write_model, _parse_file_type


class TestHiddenPrints(unittest.TestCase):
    def test_hidden_prints(self):
        """
        Test the HiddenPrints context manager
        """
        ...
        self.assertTrue(capturedOutput.getvalue() == "This should be printed\n")
