...
from hippotools.diversity.utils import parse_model_method, create_iterator
    ...
    for sol, stat in iterator:
        ...
        if context_method == "enforce_off":
            ...
            manager = EnforceInactive(
                base_model, solution=sol, epsilon=epsilon, low_expr_rxns=low_expr_rxns
            )
            ...
            manager = EnforceActive(
                base_model, solution=sol, epsilon=epsilon, high_expr_rxns=high_expr_rxns
            )
